...
Moy=load(strcat(basedir,'CANYON-MED_weights/moy_CT.txt'));
Ecart=load(strcat(basedir,'CANYON-MED_weights/std_CT.txt'));
...
for i=1:n_list
    b1=load(strcat(basedir,'CANYON-MED_weights/poids_CT_b1_',string(i),'.txt'));
    b2=load(strcat(basedir,'CANYON-MED_weights/poids_CT_b2_',string(i),'.txt'));
    b3=load(strcat(basedir,'CANYON-MED_weights/poids_CT_b3_',string(i),'.txt'));
    IW=load(strcat(basedir,'CANYON-MED_weights/poids_CT_IW_',string(i),'.txt'));
    LW1=load(strcat(basedir,'CANYON-MED_weights/poids_CT_LW1_',string(i),'.txt'));
    LW2=load(strcat(basedir,'CANYON-MED_weights/poids_CT_LW2_',string(i),'.txt'));
