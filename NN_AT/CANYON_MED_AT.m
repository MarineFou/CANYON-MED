...
for i=1:n_list
    b1=load(strcat('weights_biases\poids_AT_b1_',string(i),'.txt'));
    b2=load(strcat('weights_biases\poids_AT_b2_',string(i),'.txt'));
    b3=load(strcat('weights_biases\poids_AT_b3_',string(i),'.txt'));
    IW=load(strcat('weights_biases\poids_AT_IW_',string(i),'.txt'));
    LW1=load(strcat('weights_biases\poids_AT_LW1_',string(i),'.txt'));
    LW2=load(strcat('weights_biases\poids_AT_LW2_',string(i),'.txt'));
